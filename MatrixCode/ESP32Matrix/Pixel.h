class Pixel{
  const uint8_t SpritealienData[96] = {
    B8_2BIT(00003111),B8_2BIT(11130000),
    B8_2BIT(00311111),B8_2BIT(11111300),
    B8_2BIT(03111111),B8_2BIT(11111130),
    ...
    B8_2BIT(03111111),B8_2BIT(11111130),
    B8_2BIT(00311111),B8_2BIT(11111300),
    B8_2BIT(00031111),B8_2BIT(11113000),
    B8_2BIT(00000311),B8_2BIT(11300000) };

  const uint8_t SpritealienData1[96] = {
...
//    sprInvader.SetPosition(random8(0,5),random8(0,8));
    sprInvader.SetPosition(random8(8,12),random8(8,16));
...
//    sprInvader3.SetPosition(random8(0,5),random8(0,8));
  ...
  void squares() {
    ...
    for (uint8_t i = 0; i < 16; i++) {
      leds.DrawRectangle(i, i, 14 - i, 14 - i, CHSV(rectHue + (i*15),255,255));
    }
    //Bottom right
    for (uint8_t i = 0; i < 16; i++) {
      leds.DrawRectangle(i+17, i, 31 - i, 14 - i, CHSV(rectHue + (i*15),255,255));
    }
    // Top left
    for (uint8_t i = 0; i < 16; i++) {
      leds.DrawRectangle(i, i+17, 14 - i, 31 - i, CHSV(rectHue + (i*15),255,255));
    }
    // Top right
    for (uint8_t i = 0; i < 16; i++) {
      leds.DrawRectangle(i+17, i+17, 31 - i, 31 - i, CHSV(rectHue + (i*15),255,255));
    }
    rectHue++;
  }
